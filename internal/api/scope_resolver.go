...
// lives here and is handed to the Enforce* helpers by the handlers
// (#7 S6).
...
// belongs to (static + dynamic-materialized — ListForDevice reads the
// materialized membership projection).
